...
export default function LeftSidebar() {
  ...
  return (
    <div 
      className={`rounded-[20px] transition-all ${isCollapsed ? 'w-0 overflow-hidden' : 'w-[260px]'}`}
      style={{
        background: "#000000",
        height: '100dvh',
    ...
    >
      <div className="pt-6 px-6 pb-[7px] flex flex-col relative" style={{ boxSizing: 'border-box', height: '100%', overflowY: 'auto', overflowX: 'hidden', flex: '1 1 0', minHeight: 0, width: '100%' }}>
